...
static const char* PredictorService_method_names[] = {
  ...
  "/PredictorService/PredictorEvaluate",
};
...
PredictorService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_PredictorEvaluate_(PredictorService_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status PredictorService::Stub::PredictorEvaluate(::grpc::ClientContext* context, const ::PredictorEvaluateRequest& request, ::MulticlassMetricsResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_PredictorEvaluate_, context, request, response);
}

void PredictorService::Stub::experimental_async::PredictorEvaluate(::grpc::ClientContext* context, const ::PredictorEvaluateRequest* request, ::MulticlassMetricsResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_PredictorEvaluate_, context, request, response, std::move(f));
}

void PredictorService::Stub::experimental_async::PredictorEvaluate(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::MulticlassMetricsResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_PredictorEvaluate_, context, request, response, std::move(f));
}

void PredictorService::Stub::experimental_async::PredictorEvaluate(::grpc::ClientContext* context, const ::PredictorEvaluateRequest* request, ::MulticlassMetricsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_PredictorEvaluate_, context, request, response, reactor);
}

void PredictorService::Stub::experimental_async::PredictorEvaluate(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::MulticlassMetricsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_PredictorEvaluate_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::MulticlassMetricsResponse>* PredictorService::Stub::AsyncPredictorEvaluateRaw(::grpc::ClientContext* context, const ::PredictorEvaluateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::MulticlassMetricsResponse>::Create(channel_.get(), cq, rpcmethod_PredictorEvaluate_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::MulticlassMetricsResponse>* PredictorService::Stub::PrepareAsyncPredictorEvaluateRaw(::grpc::ClientContext* context, const ::PredictorEvaluateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::MulticlassMetricsResponse>::Create(channel_.get(), cq, rpcmethod_PredictorEvaluate_, context, request, false);
}
...
PredictorService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< PredictorService::Service, ::PredictorPredictRequest, ::PredictorPredictResponse>(
          std::mem_fn(&PredictorService::Service::PredictorPredict), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< PredictorService::Service, ::PredictorPredictSQLQueryRequest, ::PredictorPredictResponse>(
          std::mem_fn(&PredictorService::Service::PredictorPredictSQLQuery), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< PredictorService::Service, ::PredictorTrainRequest, ::PredictorTrainResponse>(
          std::mem_fn(&PredictorService::Service::PredictorTrain), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< PredictorService::Service, ::PredictorTrainRequest, ::PredictorTrainResponse>(
          std::mem_fn(&PredictorService::Service::PredictorTrainStream), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< PredictorService::Service, ::PredictorGetWeightsRequest, ::PredictorGetWeightsResponse>(
          std::mem_fn(&PredictorService::Service::PredictorGetWeights), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< PredictorService::Service, ::PredictorTrainAndEvalRequest, ::MulticlassMetricsResponse>(
          std::mem_fn(&PredictorService::Service::PredictorGetMulticlassMetrics), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      PredictorService_method_names[6],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< PredictorService::Service, ::PredictorEvaluateRequest, ::MulticlassMetricsResponse>(
          std::mem_fn(&PredictorService::Service::PredictorEvaluate), this)));
}
...
::grpc::Status PredictorService::Service::PredictorEvaluate(::grpc::ServerContext* context, const ::PredictorEvaluateRequest* request, ::MulticlassMetricsResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
