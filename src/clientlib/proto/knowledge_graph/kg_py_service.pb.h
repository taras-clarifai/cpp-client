...
inline void ConceptEmbeddingDump::set_location(const char* value, size_t size) {
...
inline const std::string& CustomerDataDump::locaiton() const {
  ...
  return locaiton_.GetNoArena();
}
inline void CustomerDataDump::set_locaiton(const std::string& value) {
  
  locaiton_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
...
inline void CustomerDataDump::set_locaiton(const char* value) {
  ...
  locaiton_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:clarifai.api.CustomerDataDump.locaiton)
}
inline void CustomerDataDump::set_locaiton(const char* value, size_t size) {
  
  locaiton_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* CustomerDataDump::mutable_locaiton() {
  ...
  return locaiton_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* CustomerDataDump::release_locaiton() {
  ...
  return locaiton_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void CustomerDataDump::set_allocated_locaiton(std::string* locaiton) {
  ...
  locaiton_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), locaiton);
...
inline ::clarifai::api::CustomerDataDump* PostKnowledgeGraphMatchRequest::mutable_customer_data() {
  ...
  if (customer_data_ == nullptr) {
    auto* p = CreateMaybeMessage<::clarifai::api::CustomerDataDump>(GetArenaNoVirtual());
    customer_data_ = p;
  }
