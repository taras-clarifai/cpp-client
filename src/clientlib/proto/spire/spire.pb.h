...
class SpireConfig :
 ...
 public:
  ...
  private:
  int _internal_landmark_points_size() const;
  public:
  ...
  private:
  const std::string& _internal_landmark_points(int index) const;
  std::string* _internal_add_landmark_points();
  public:
  ...
  private:
  bool _internal_denoise_video_embeddings() const;
  void _internal_set_denoise_video_embeddings(bool value);
  public:
...
inline bool SpireConfig::_internal_denoise_video_embeddings() const {
...
inline bool SpireConfig::denoise_video_embeddings() const {
  ...
  return _internal_denoise_video_embeddings();
}
inline void SpireConfig::_internal_set_denoise_video_embeddings(bool value) {
  
  denoise_video_embeddings_ = value;
}
inline void SpireConfig::set_denoise_video_embeddings(bool value) {
  _internal_set_denoise_video_embeddings(value);
...
// repeated string landmark_points = 29;
inline int SpireConfig::_internal_landmark_points_size() const {
  return landmark_points_.size();
}
inline int SpireConfig::landmark_points_size() const {
  return _internal_landmark_points_size();
}
...
inline std::string* SpireConfig::add_landmark_points() {
  ...
  return _internal_add_landmark_points();
}
inline const std::string& SpireConfig::_internal_landmark_points(int index) const {
...
inline const std::string& SpireConfig::landmark_points(int index) const {
  ...
  return _internal_landmark_points(index);
}
...
inline std::string* SpireConfig::_internal_add_landmark_points() {
