...
inline bool ModelFormat_Parse(
    const std::string& name, ModelFormat* value) {
...
class ModelBytes :
 ...
 public:
  ...
  void clear_tokenizer_vocab();
  const std::string& tokenizer_vocab() const;
  void set_tokenizer_vocab(const std::string& value);
  void set_tokenizer_vocab(std::string&& value);
  void set_tokenizer_vocab(const char* value);
  void set_tokenizer_vocab(const char* value, size_t size);
  std::string* mutable_tokenizer_vocab();
  std::string* release_tokenizer_vocab();
  void set_allocated_tokenizer_vocab(std::string* tokenizer_vocab);
  private:
  const std::string& _internal_tokenizer_vocab() const;
  void _internal_set_tokenizer_vocab(const std::string& value);
  std::string* _internal_mutable_tokenizer_vocab();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr tokenizer_vocab_;
  int model_format_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_proto_2futils_2fcheckpoint_2eproto;
};
...
inline const std::string& LoadCheckpointScope::_internal_checkpoint() const {
  if (_internal_has_checkpoint()) {
    return source_.checkpoint_.GetNoArena();
  }
...
inline void LoadCheckpointScope::_internal_set_checkpoint(const std::string& value) {
  ...
  source_.checkpoint_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LoadCheckpointScope::set_checkpoint(std::string&& value) {
  ...
  source_.checkpoint_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void LoadCheckpointScope::set_checkpoint(const char* value) {
  ...
  source_.checkpoint_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(value));
  // @@protoc_insertion_point(field_set_char:LoadCheckpointScope.checkpoint)
}
inline void LoadCheckpointScope::set_checkpoint(const char* value, size_t size) {
  if (!_internal_has_checkpoint()) {
    clear_source();
    set_has_checkpoint();
    source_.checkpoint_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  source_.checkpoint_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* LoadCheckpointScope::_internal_mutable_checkpoint() {
  ...
  return source_.checkpoint_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LoadCheckpointScope::release_checkpoint() {
  ...
  if (_internal_has_checkpoint()) {
    clear_has_source();
    return source_.checkpoint_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  } else {
    return nullptr;
  }
}
...
inline ::ModelBytes* LoadCheckpointScope::_internal_mutable_model_bytes() {
  if (!_internal_has_model_bytes()) {
    clear_source();
    set_has_model_bytes();
    source_.model_bytes_ = CreateMaybeMessage< ::ModelBytes >(
        GetArenaNoVirtual());
  }
...
inline void LoadCheckpointScope::set_regex(const char* value, size_t size) {
...
inline const std::string& LoadCheckpointScope::_internal_checkpoint_regex() const {
  return checkpoint_regex_.GetNoArena();
}
inline void LoadCheckpointScope::_internal_set_checkpoint_regex(const std::string& value) {
  
  checkpoint_regex_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LoadCheckpointScope::set_checkpoint_regex(std::string&& value) {
  
  checkpoint_regex_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void LoadCheckpointScope::set_checkpoint_regex(const char* value) {
  ...
  checkpoint_regex_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:LoadCheckpointScope.checkpoint_regex)
}
inline void LoadCheckpointScope::set_checkpoint_regex(const char* value, size_t size) {
  
  checkpoint_regex_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* LoadCheckpointScope::_internal_mutable_checkpoint_regex() {
  ...
  return checkpoint_regex_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LoadCheckpointScope::release_checkpoint_regex() {
  ...
  return checkpoint_regex_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LoadCheckpointScope::set_allocated_checkpoint_regex(std::string* checkpoint_regex) {
  ...
  checkpoint_regex_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), checkpoint_regex);
...
inline void LoadCheckpointScope::set_exclude_regex(const char* value) {
  ...
  exclude_regex_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:LoadCheckpointScope.exclude_regex)
}
inline void LoadCheckpointScope::set_exclude_regex(const char* value, size_t size) {
  
  exclude_regex_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* LoadCheckpointScope::_internal_mutable_exclude_regex() {
  ...
  return exclude_regex_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LoadCheckpointScope::release_exclude_regex() {
  ...
  return exclude_regex_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LoadCheckpointScope::set_allocated_exclude_regex(std::string* exclude_regex) {
  ...
  exclude_regex_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), exclude_regex);
...
inline const std::string& ModelBytes::_internal_frozen_meta_graph() const {
  return frozen_meta_graph_.GetNoArena();
}
inline void ModelBytes::_internal_set_frozen_meta_graph(const std::string& value) {
  
  frozen_meta_graph_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ModelBytes::set_frozen_meta_graph(std::string&& value) {
  
  frozen_meta_graph_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ModelBytes::set_frozen_meta_graph(const char* value) {
  ...
  frozen_meta_graph_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ModelBytes.frozen_meta_graph)
}
inline void ModelBytes::set_frozen_meta_graph(const void* value, size_t size) {
  
  frozen_meta_graph_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* ModelBytes::_internal_mutable_frozen_meta_graph() {
  ...
  return frozen_meta_graph_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ModelBytes::release_frozen_meta_graph() {
  // @@protoc_insertion_point(field_release:ModelBytes.frozen_meta_graph)
  
  return frozen_meta_graph_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ModelBytes::set_allocated_frozen_meta_graph(std::string* frozen_meta_graph) {
  ...
  frozen_meta_graph_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), frozen_meta_graph);
...
inline const std::string& ModelBytes::_internal_mmapped_graph_def() const {
  return mmapped_graph_def_.GetNoArena();
}
inline void ModelBytes::_internal_set_mmapped_graph_def(const std::string& value) {
  
  mmapped_graph_def_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ModelBytes::set_mmapped_graph_def(std::string&& value) {
  
  mmapped_graph_def_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ModelBytes::set_mmapped_graph_def(const char* value) {
  ...
  mmapped_graph_def_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ModelBytes.mmapped_graph_def)
}
inline void ModelBytes::set_mmapped_graph_def(const void* value, size_t size) {
  
  mmapped_graph_def_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* ModelBytes::_internal_mutable_mmapped_graph_def() {
  ...
  return mmapped_graph_def_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ModelBytes::release_mmapped_graph_def() {
  // @@protoc_insertion_point(field_release:ModelBytes.mmapped_graph_def)
  
  return mmapped_graph_def_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ModelBytes::set_allocated_mmapped_graph_def(std::string* mmapped_graph_def) {
  ...
  mmapped_graph_def_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), mmapped_graph_def);
...
inline const std::string& ModelBytes::_internal_serialized_trace() const {
  return serialized_trace_.GetNoArena();
}
inline void ModelBytes::_internal_set_serialized_trace(const std::string& value) {
  
  serialized_trace_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ModelBytes::set_serialized_trace(std::string&& value) {
  
  serialized_trace_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ModelBytes::set_serialized_trace(const char* value) {
  ...
  serialized_trace_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ModelBytes.serialized_trace)
}
inline void ModelBytes::set_serialized_trace(const void* value, size_t size) {
  
  serialized_trace_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* ModelBytes::_internal_mutable_serialized_trace() {
  ...
  return serialized_trace_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ModelBytes::release_serialized_trace() {
  // @@protoc_insertion_point(field_release:ModelBytes.serialized_trace)
  
  return serialized_trace_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ModelBytes::set_allocated_serialized_trace(std::string* serialized_trace) {
  ...
  serialized_trace_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), serialized_trace);
...
inline void ModelBytes::set_device_type(const char* value, size_t size) {
...
inline const std::string& ModelBytes::_internal_model_module() const {
  return model_module_.GetNoArena();
}
inline void ModelBytes::_internal_set_model_module(const std::string& value) {
  
  model_module_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ModelBytes::set_model_module(std::string&& value) {
  
  model_module_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ModelBytes::set_model_module(const char* value) {
  ...
  model_module_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ModelBytes.model_module)
}
inline void ModelBytes::set_model_module(const char* value, size_t size) {
  
  model_module_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* ModelBytes::_internal_mutable_model_module() {
  ...
  return model_module_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ModelBytes::release_model_module() {
  // @@protoc_insertion_point(field_release:ModelBytes.model_module)
  
  return model_module_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ModelBytes::set_allocated_model_module(std::string* model_module) {
  ...
  model_module_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), model_module);
  // @@protoc_insertion_point(field_set_allocated:ModelBytes.model_module)
}

// string tokenizer_vocab = 7;
inline void ModelBytes::clear_tokenizer_vocab() {
  tokenizer_vocab_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ModelBytes::tokenizer_vocab() const {
  // @@protoc_insertion_point(field_get:ModelBytes.tokenizer_vocab)
  return _internal_tokenizer_vocab();
}
inline void ModelBytes::set_tokenizer_vocab(const std::string& value) {
  _internal_set_tokenizer_vocab(value);
  // @@protoc_insertion_point(field_set:ModelBytes.tokenizer_vocab)
}
inline std::string* ModelBytes::mutable_tokenizer_vocab() {
  // @@protoc_insertion_point(field_mutable:ModelBytes.tokenizer_vocab)
  return _internal_mutable_tokenizer_vocab();
}
inline const std::string& ModelBytes::_internal_tokenizer_vocab() const {
  return tokenizer_vocab_.GetNoArena();
}
inline void ModelBytes::_internal_set_tokenizer_vocab(const std::string& value) {
  
  tokenizer_vocab_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ModelBytes::set_tokenizer_vocab(std::string&& value) {
  
  tokenizer_vocab_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:ModelBytes.tokenizer_vocab)
}
inline void ModelBytes::set_tokenizer_vocab(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  tokenizer_vocab_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ModelBytes.tokenizer_vocab)
}
inline void ModelBytes::set_tokenizer_vocab(const char* value, size_t size) {
  
  tokenizer_vocab_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ModelBytes.tokenizer_vocab)
}
inline std::string* ModelBytes::_internal_mutable_tokenizer_vocab() {
  
  return tokenizer_vocab_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ModelBytes::release_tokenizer_vocab() {
  // @@protoc_insertion_point(field_release:ModelBytes.tokenizer_vocab)
  
  return tokenizer_vocab_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ModelBytes::set_allocated_tokenizer_vocab(std::string* tokenizer_vocab) {
  if (tokenizer_vocab != nullptr) {
    
  } else {
    
  }
  tokenizer_vocab_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), tokenizer_vocab);
  // @@protoc_insertion_point(field_set_allocated:ModelBytes.tokenizer_vocab)
}
