...
static bool descriptor_table_proto_2futils_2fboundingbox_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2futils_2fboundingbox_2eproto = {
  &descriptor_table_proto_2futils_2fboundingbox_2eproto_initialized, descriptor_table_protodef_proto_2futils_2fboundingbox_2eproto, "proto/utils/boundingbox.proto", 335,
...
static bool dynamic_init_dummy_proto_2futils_2fboundingbox_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2futils_2fboundingbox_2eproto), true);
...
BoundingBox::BoundingBox(const BoundingBox& from)
  ...
  ::memcpy(&top_row_, &from.top_row_,
    static_cast<size_t>(reinterpret_cast<char*>(&is_positive_) -
    reinterpret_cast<char*>(&top_row_)) + sizeof(is_positive_));
...
void BoundingBox::SharedCtor() {
  ...
  ::memset(&top_row_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&is_positive_) -
      reinterpret_cast<char*>(&top_row_)) + sizeof(is_positive_));
}
...
template<> PROTOBUF_NOINLINE ::BoundingBox* Arena::CreateMaybeMessage< ::BoundingBox >(Arena* arena) {
  return Arena::CreateInternal< ::BoundingBox >(arena);
}
