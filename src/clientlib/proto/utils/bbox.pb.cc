...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_BBox_proto_2futils_2fbbox_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_BBox_proto_2futils_2fbbox_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Mask_proto_2futils_2fbbox_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_Mask_proto_2futils_2fbbox_2eproto}, {}};
...
static bool descriptor_table_proto_2futils_2fbbox_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2futils_2fbbox_2eproto = {
  &descriptor_table_proto_2futils_2fbbox_2eproto_initialized, descriptor_table_protodef_proto_2futils_2fbbox_2eproto, "proto/utils/bbox.proto", 228,
...
static bool dynamic_init_dummy_proto_2futils_2fbbox_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2futils_2fbbox_2eproto), true);
...
Mask::Mask()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Mask)
}
Mask::Mask(const Mask& from)
  ...
  if (!from.encoded_bytes().empty()) {
    encoded_bytes_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.encoded_bytes_);
  }
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:Mask)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Mask)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Mask)
  return false;
#undef DO_
}
...
void Mask::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Mask)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:Mask)
}

::PROTOBUF_NAMESPACE_ID::uint8* Mask::InternalSerializeWithCachedSizesToArray(
...
void Mask::InternalSwap(Mask* other) {
  ...
  encoded_bytes_.Swap(&other->encoded_bytes_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
}
...
::PROTOBUF_NAMESPACE_ID::uint8* BBox::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
...
template<> PROTOBUF_NOINLINE ::Mask* Arena::CreateMaybeMessage< ::Mask >(Arena* arena) {
  return Arena::CreateInternal< ::Mask >(arena);
}
template<> PROTOBUF_NOINLINE ::BBox* Arena::CreateMaybeMessage< ::BBox >(Arena* arena) {
  return Arena::CreateInternal< ::BBox >(arena);
}
