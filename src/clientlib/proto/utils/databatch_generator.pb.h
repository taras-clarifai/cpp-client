...
inline const ::ImageDatasetReaderParams& DataBatchGeneratorParams::image_dataset_reader_params() const {
  ...
  return has_image_dataset_reader_params()
...
inline ::ImageDatasetReaderParams* DataBatchGeneratorParams::mutable_image_dataset_reader_params() {
  if (!has_image_dataset_reader_params()) {
    ...
    generator_.image_dataset_reader_params_ = CreateMaybeMessage< ::ImageDatasetReaderParams >(
        GetArenaNoVirtual());
  }
...
inline const ::SavedOutputReaderParams& DataBatchGeneratorParams::saved_output_reader_params() const {
  ...
  return has_saved_output_reader_params()
...
inline ::SavedOutputReaderParams* DataBatchGeneratorParams::mutable_saved_output_reader_params() {
  if (!has_saved_output_reader_params()) {
    ...
    generator_.saved_output_reader_params_ = CreateMaybeMessage< ::SavedOutputReaderParams >(
        GetArenaNoVirtual());
  }
...
inline const ::DataBatchSamplerParams& DataBatchGeneratorParams::databatch_sampler_params() const {
  ...
  return has_databatch_sampler_params()
...
inline ::DataBatchSamplerParams* DataBatchGeneratorParams::mutable_databatch_sampler_params() {
  if (!has_databatch_sampler_params()) {
    ...
    generator_.databatch_sampler_params_ = CreateMaybeMessage< ::DataBatchSamplerParams >(
        GetArenaNoVirtual());
  }
...
inline const ::gRPCDataBatchReaderParams& DataBatchGeneratorParams::grpc_databatch_reader_params() const {
  ...
  return has_grpc_databatch_reader_params()
...
inline ::gRPCDataBatchReaderParams* DataBatchGeneratorParams::mutable_grpc_databatch_reader_params() {
  if (!has_grpc_databatch_reader_params()) {
    ...
    generator_.grpc_databatch_reader_params_ = CreateMaybeMessage< ::gRPCDataBatchReaderParams >(
        GetArenaNoVirtual());
  }
...
inline const ::PastingDataProviderParams& DataBatchGeneratorParams::pasting_data_provider_params() const {
  ...
  return has_pasting_data_provider_params()
...
inline ::PastingDataProviderParams* DataBatchGeneratorParams::mutable_pasting_data_provider_params() {
  if (!has_pasting_data_provider_params()) {
    ...
    generator_.pasting_data_provider_params_ = CreateMaybeMessage< ::PastingDataProviderParams >(
        GetArenaNoVirtual());
  }
...
inline void DatasetReaderParams::set_dataset(const char* value, size_t size) {
...
inline void DatasetReaderParams::set_split(const char* value, size_t size) {
...
inline ::DatasetReaderParams* ImageDatasetReaderParams::mutable_dataset_reader_params() {
  ...
  if (dataset_reader_params_ == nullptr) {
    auto* p = CreateMaybeMessage<::DatasetReaderParams>(GetArenaNoVirtual());
...
inline void SavedOutputReaderParams::set_layer_name(const char* value, size_t size) {
...
inline std::string* SavedOutputReaderParams::release_layer_name() {
  ...
  return layer_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
