...
inline const std::string& Text::_internal_hosted_orig_url() const {
  return hosted_orig_url_.GetNoArena();
}
inline void Text::_internal_set_hosted_orig_url(const std::string& value) {
...
inline std::string* Text::_internal_mutable_hosted_orig_url() {
