...
class Tag :
 ...
 public:
  ...
  enum : int {
    ...
    kUserUniqueVocabIdFieldNumber = 8,
...
inline void Tag::set_aiid(const char* value, size_t size) {
...
inline void Tag::set_cname(const char* value, size_t size) {
...
inline const std::string& Tag::_internal_user_unique_concept_id() const {
  return user_unique_concept_id_.GetNoArena();
}
inline void Tag::_internal_set_user_unique_concept_id(const std::string& value) {
  
  user_unique_concept_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Tag::set_user_unique_concept_id(std::string&& value) {
  
  user_unique_concept_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void Tag::set_user_unique_concept_id(const char* value) {
  ...
  user_unique_concept_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Tag.user_unique_concept_id)
}
inline void Tag::set_user_unique_concept_id(const char* value, size_t size) {
  
  user_unique_concept_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* Tag::_internal_mutable_user_unique_concept_id() {
  ...
  return user_unique_concept_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Tag::release_user_unique_concept_id() {
  // @@protoc_insertion_point(field_release:Tag.user_unique_concept_id)
  
  return user_unique_concept_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Tag::set_allocated_user_unique_concept_id(std::string* user_unique_concept_id) {
  ...
  user_unique_concept_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), user_unique_concept_id);
...
inline const std::string& Tag::_internal_user_unique_app_id() const {
  return user_unique_app_id_.GetNoArena();
}
inline void Tag::_internal_set_user_unique_app_id(const std::string& value) {
  
  user_unique_app_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Tag::set_user_unique_app_id(std::string&& value) {
  
  user_unique_app_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void Tag::set_user_unique_app_id(const char* value) {
  ...
  user_unique_app_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Tag.user_unique_app_id)
}
inline void Tag::set_user_unique_app_id(const char* value, size_t size) {
  
  user_unique_app_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* Tag::_internal_mutable_user_unique_app_id() {
  ...
  return user_unique_app_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Tag::release_user_unique_app_id() {
  // @@protoc_insertion_point(field_release:Tag.user_unique_app_id)
  
  return user_unique_app_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Tag::set_allocated_user_unique_app_id(std::string* user_unique_app_id) {
  ...
  user_unique_app_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), user_unique_app_id);
...
inline const std::string& Tag::_internal_user_unique_user_id() const {
  return user_unique_user_id_.GetNoArena();
}
inline void Tag::_internal_set_user_unique_user_id(const std::string& value) {
  
  user_unique_user_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Tag::set_user_unique_user_id(std::string&& value) {
  
  user_unique_user_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void Tag::set_user_unique_user_id(const char* value) {
  ...
  user_unique_user_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Tag.user_unique_user_id)
}
inline void Tag::set_user_unique_user_id(const char* value, size_t size) {
  
  user_unique_user_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* Tag::_internal_mutable_user_unique_user_id() {
  ...
  return user_unique_user_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Tag::release_user_unique_user_id() {
  // @@protoc_insertion_point(field_release:Tag.user_unique_user_id)
  
  return user_unique_user_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Tag::set_allocated_user_unique_user_id(std::string* user_unique_user_id) {
  ...
  user_unique_user_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), user_unique_user_id);
  // @@protoc_insertion_point(field_set_allocated:Tag.user_unique_user_id)
}

// string user_unique_vocab_id = 8;
inline void Tag::clear_user_unique_vocab_id() {
  user_unique_vocab_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Tag::user_unique_vocab_id() const {
  // @@protoc_insertion_point(field_get:Tag.user_unique_vocab_id)
  return _internal_user_unique_vocab_id();
}
inline void Tag::set_user_unique_vocab_id(const std::string& value) {
  _internal_set_user_unique_vocab_id(value);
  // @@protoc_insertion_point(field_set:Tag.user_unique_vocab_id)
}
inline std::string* Tag::mutable_user_unique_vocab_id() {
  // @@protoc_insertion_point(field_mutable:Tag.user_unique_vocab_id)
  return _internal_mutable_user_unique_vocab_id();
}
inline const std::string& Tag::_internal_user_unique_vocab_id() const {
  return user_unique_vocab_id_.GetNoArena();
}
inline void Tag::_internal_set_user_unique_vocab_id(const std::string& value) {
  
  user_unique_vocab_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Tag::set_user_unique_vocab_id(std::string&& value) {
  
  user_unique_vocab_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:Tag.user_unique_vocab_id)
}
inline void Tag::set_user_unique_vocab_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  user_unique_vocab_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Tag.user_unique_vocab_id)
}
inline void Tag::set_user_unique_vocab_id(const char* value, size_t size) {
  
  user_unique_vocab_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Tag.user_unique_vocab_id)
}
inline std::string* Tag::_internal_mutable_user_unique_vocab_id() {
  
  return user_unique_vocab_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Tag::release_user_unique_vocab_id() {
  // @@protoc_insertion_point(field_release:Tag.user_unique_vocab_id)
  
  return user_unique_vocab_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Tag::set_allocated_user_unique_vocab_id(std::string* user_unique_vocab_id) {
  if (user_unique_vocab_id != nullptr) {
    
  } else {
    
  }
  user_unique_vocab_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), user_unique_vocab_id);
  // @@protoc_insertion_point(field_set_allocated:Tag.user_unique_vocab_id)
}
