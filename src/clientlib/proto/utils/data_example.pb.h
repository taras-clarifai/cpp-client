...
class Region_RegionInfo :
 ...
 public:
  ...
  private:
  const ::Polygon& _internal_polygon() const;
  ::Polygon* _internal_mutable_polygon();
  public:
...
// .Polygon polygon = 5;
inline bool Region_RegionInfo::_internal_has_polygon() const {
...
inline const ::Polygon& Region_RegionInfo::_internal_polygon() const {
...
inline ::Polygon* Region_RegionInfo::_internal_mutable_polygon() {
