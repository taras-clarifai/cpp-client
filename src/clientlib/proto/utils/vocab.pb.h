...
inline void Vocab::set_user_unique_vocab_id(const char* value, size_t size) {
...
inline void Vocab::set_user_unique_app_id(const char* value, size_t size) {
...
inline void Vocab::set_user_unique_user_id(const char* value, size_t size) {
