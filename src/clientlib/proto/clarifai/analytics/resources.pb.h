...
inline bool AnalyticsEventType_Parse(
    const std::string& name, AnalyticsEventType* value) {
...
inline bool NetworkConnectivity_Parse(
    const std::string& name, NetworkConnectivity* value) {
...
inline bool RunningMode_Parse(
    const std::string& name, RunningMode* value) {
...
inline bool RunningEnvironment_Parse(
    const std::string& name, RunningEnvironment* value) {
...
inline void EventSummary::set_name(const char* value, size_t size) {
...
inline void EventSummary::set_model_id(const char* value, size_t size) {
...
inline void EventSummary::set_model_version_id(const char* value, size_t size) {
...
inline void HostAppInfo::set_build_number(const char* value, size_t size) {
...
inline std::string* HostAppInfo::release_build_number() {
  ...
  return build_number_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline void HostAppInfo::set_api_key(const char* value, size_t size) {
...
inline void HostAppInfo::set_version(const char* value, size_t size) {
...
inline void SDK::set_version(const char* value, size_t size) {
...
inline void SDK::set_build(const char* value, size_t size) {
...
inline void State::set_country_code(const char* value, size_t size) {
...
inline void State::set_language_code(const char* value, size_t size) {
...
inline const std::string& State::_internal_time_zone_abbreviation() const {
  return time_zone_abbreviation_.GetNoArena();
}
inline void State::_internal_set_time_zone_abbreviation(const std::string& value) {
  
  time_zone_abbreviation_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void State::set_time_zone_abbreviation(std::string&& value) {
  
  time_zone_abbreviation_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void State::set_time_zone_abbreviation(const char* value) {
  ...
  time_zone_abbreviation_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:clarifai.analytics.State.time_zone_abbreviation)
}
inline void State::set_time_zone_abbreviation(const char* value, size_t size) {
  
  time_zone_abbreviation_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* State::_internal_mutable_time_zone_abbreviation() {
  ...
  return time_zone_abbreviation_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* State::release_time_zone_abbreviation() {
  ...
  return time_zone_abbreviation_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void State::set_allocated_time_zone_abbreviation(std::string* time_zone_abbreviation) {
  ...
  time_zone_abbreviation_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), time_zone_abbreviation);
...
inline void Analytics::set_batch_unique_identifier(const char* value, size_t size) {
...
inline void Analytics::set_system_uuid(const char* value, size_t size) {
...
inline void Event::set_model_id(const char* value, size_t size) {
...
inline void Event::set_model_version_id(const char* value, size_t size) {
