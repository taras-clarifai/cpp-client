...
const char descriptor_table_protodef_proto_2fclarifai_2fsdk_5fbilling_2fresources_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "alytics.SDKB5\n\035com.clarifai.grpc.sdk_bil"
  "lingP\001Z\013sdk_billing\242\002\004CAIPb\006proto3"
  ;
...
static bool descriptor_table_proto_2fclarifai_2fsdk_5fbilling_2fresources_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fclarifai_2fsdk_5fbilling_2fresources_2eproto = {
  &descriptor_table_proto_2fclarifai_2fsdk_5fbilling_2fresources_2eproto_initialized, descriptor_table_protodef_proto_2fclarifai_2fsdk_5fbilling_2fresources_2eproto, "proto/clarifai/sdk_billing/resources.proto", 594,
...
static bool dynamic_init_dummy_proto_2fclarifai_2fsdk_5fbilling_2fresources_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fclarifai_2fsdk_5fbilling_2fresources_2eproto), true);
namespace clarifai {
namespace sdk_billing {
...
SDKBillingCycle::SDKBillingCycle()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:clarifai.sdk_billing.SDKBillingCycle)
}
...
SDKBilling::SDKBilling()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:clarifai.sdk_billing.SDKBilling)
}
...
template<> PROTOBUF_NOINLINE ::clarifai::sdk_billing::SDKBillingCycle* Arena::CreateMaybeMessage< ::clarifai::sdk_billing::SDKBillingCycle >(Arena* arena) {
  return Arena::CreateInternal< ::clarifai::sdk_billing::SDKBillingCycle >(arena);
}
template<> PROTOBUF_NOINLINE ::clarifai::sdk_billing::SDKBilling* Arena::CreateMaybeMessage< ::clarifai::sdk_billing::SDKBilling >(Arena* arena) {
  return Arena::CreateInternal< ::clarifai::sdk_billing::SDKBilling >(arena);
}
