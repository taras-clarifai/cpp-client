...
inline void DataDump::set_id(const char* value, size_t size) {
...
inline void DataDump::set_app_id(const char* value, size_t size) {
...
inline ::clarifai::bulk_data_service::PostDataDumpsRequest* DataDump::mutable_request() {
  ...
  if (request_ == nullptr) {
    auto* p = CreateMaybeMessage<::clarifai::bulk_data_service::PostDataDumpsRequest>(GetArenaNoVirtual());
    request_ = p;
  }
...
inline void DataDump::set_location(const char* value, size_t size) {
...
inline void DataDump::set_created_by(const char* value, size_t size) {
