...
class EventParam :
 ...
 public:
  ...
  private:
  const ::clarifai::usage::PredictEvent& _internal_predict() const;
  ::clarifai::usage::PredictEvent* _internal_mutable_predict();
  public:
  ...
  private:
  const ::clarifai::usage::AssetEvent& _internal_asset() const;
  ::clarifai::usage::AssetEvent* _internal_mutable_asset();
  public:
...
class Model :
 ...
 public:
  ...
  private:
  ::clarifai::usage::Ownership _internal_ownership() const;
  void _internal_set_ownership(::clarifai::usage::Ownership value);
  public:
...
class PredictEvent :
 ...
 public:
  ...
  private:
  ::clarifai::usage::PredictType _internal_predict_type() const;
  void _internal_set_predict_type(::clarifai::usage::PredictType value);
  public:
...
inline const ::clarifai::usage::PredictEvent& EventParam::_internal_predict() const {
  return _internal_has_predict()
      ? *event_.predict_
...
inline ::clarifai::usage::PredictEvent* EventParam::_internal_mutable_predict() {
  if (!_internal_has_predict()) {
    clear_event();
    set_has_predict();
...
// .clarifai.usage.AssetEvent asset = 6;
inline bool EventParam::_internal_has_asset() const {
...
inline const ::clarifai::usage::AssetEvent& EventParam::_internal_asset() const {
  return _internal_has_asset()
      ? *event_.asset_
...
inline ::clarifai::usage::AssetEvent* EventParam::_internal_mutable_asset() {
  if (!_internal_has_asset()) {
    clear_event();
    set_has_asset();
...
inline ::clarifai::usage::Ownership Model::_internal_ownership() const {
...
inline void Model::_internal_set_ownership(::clarifai::usage::Ownership value) {
...
// .clarifai.usage.Model model = 1;
inline bool PredictEvent::_internal_has_model() const {
...
inline const ::clarifai::usage::Model& PredictEvent::_internal_model() const {
...
inline ::clarifai::usage::Model* PredictEvent::_internal_mutable_model() {
...
inline const std::string& PredictEvent::_internal_input_type() const {
  return input_type_.GetNoArena();
}
inline void PredictEvent::_internal_set_input_type(const std::string& value) {
...
inline std::string* PredictEvent::_internal_mutable_input_type() {
...
inline ::clarifai::usage::PredictType PredictEvent::_internal_predict_type() const {
...
inline ::clarifai::usage::PredictType PredictEvent::predict_type() const {
  ...
  return _internal_predict_type();
}
inline void PredictEvent::_internal_set_predict_type(::clarifai::usage::PredictType value) {
  
  predict_type_ = value;
}
inline void PredictEvent::set_predict_type(::clarifai::usage::PredictType value) {
  _internal_set_predict_type(value);
