...
const char descriptor_table_protodef_proto_2fclarifai_2fcommands_2fcommands_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "larifai.grpc.commandsP\001Z\010commands\242\002\004CAIP"
  "b\006proto3"
  ;
...
static bool descriptor_table_proto_2fclarifai_2fcommands_2fcommands_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fclarifai_2fcommands_2fcommands_2eproto = {
  &descriptor_table_proto_2fclarifai_2fcommands_2fcommands_2eproto_initialized, descriptor_table_protodef_proto_2fclarifai_2fcommands_2fcommands_2eproto, "proto/clarifai/commands/commands.proto", 288,
...
static bool dynamic_init_dummy_proto_2fclarifai_2fcommands_2fcommands_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fclarifai_2fcommands_2fcommands_2eproto), true);
namespace clarifai {
namespace commands {
...
void Commands::clear_discard_data_older_than() {
  if (GetArenaNoVirtual() == nullptr && discard_data_older_than_ != nullptr) {
...
Commands::Commands()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:clarifai.commands.Commands)
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          timeout_delay_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          opt_out_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void Commands::InternalSwap(Commands* other) {
  ...
  swap(discard_data_older_than_, other->discard_data_older_than_);
  swap(timeout_delay_, other->timeout_delay_);
  swap(upload_interval_, other->upload_interval_);
  swap(opt_out_, other->opt_out_);
}
...
template<> PROTOBUF_NOINLINE ::clarifai::commands::Commands* Arena::CreateMaybeMessage< ::clarifai::commands::Commands >(Arena* arena) {
  return Arena::CreateInternal< ::clarifai::commands::Commands >(arena);
}
