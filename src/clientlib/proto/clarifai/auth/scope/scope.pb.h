...
enum S : int {
  ...
  All = 1,
  Predict = 2,
  Predict_Feedback PROTOBUF_DEPRECATED = 29,
  Search = 3,
  Search_Feedback PROTOBUF_DEPRECATED = 28,
  Inputs_Add = 4,
  Inputs_Get = 5,
  Inputs_Patch PROTOBUF_DEPRECATED = 7,
  Inputs_Delete = 8,
  Outputs_Patch PROTOBUF_DEPRECATED = 9,
  Concepts_Add = 10,
  Concepts_Get = 11,
  Concepts_Patch PROTOBUF_DEPRECATED = 12,
  Concepts_Delete = 13,
  Models_Add = 14,
  Models_Get = 15,
  Models_Patch PROTOBUF_DEPRECATED = 16,
  Models_Delete = 17,
  Models_Train = 26,
  Models_Sync = 27,
  Models_Deploy = 34,
  Workflows_Add = 18,
  Workflows_Get = 19,
  Workflows_Patch PROTOBUF_DEPRECATED = 20,
  Workflows_Delete = 21,
  TSNEVisualizations_Add PROTOBUF_DEPRECATED = 24,
  TSNEVisualizations_Get PROTOBUF_DEPRECATED = 25,
  Templates_Get = 33,
  Annotations_Add = 37,
  Annotations_Get = 38,
  Annotations_Patch PROTOBUF_DEPRECATED = 39,
...
constexpr S S_MAX = PasswordPolicies_Delete;
