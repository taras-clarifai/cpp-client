...
const char descriptor_table_protodef_proto_2fclarifai_2fsdk_2futils_2fsystem_5fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "_ONLY\020\001B1\n\033com.clarifai.grpc.sdk.utilsP\001"
  "Z\tsdk.utils\242\002\004CAIPb\006proto3"
  ;
...
static bool descriptor_table_proto_2fclarifai_2fsdk_2futils_2fsystem_5fconfig_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fclarifai_2fsdk_2futils_2fsystem_5fconfig_2eproto = {
  &descriptor_table_proto_2fclarifai_2fsdk_2futils_2fsystem_5fconfig_2eproto_initialized, descriptor_table_protodef_proto_2fclarifai_2fsdk_2futils_2fsystem_5fconfig_2eproto, "proto/clarifai/sdk/utils/system_config.proto", 826,
...
static bool dynamic_init_dummy_proto_2fclarifai_2fsdk_2futils_2fsystem_5fconfig_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fclarifai_2fsdk_2futils_2fsystem_5fconfig_2eproto), true);
namespace clarifai {
namespace sdk {
namespace utils {
...
SystemConfig::SystemConfig()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:clarifai.sdk.utils.SystemConfig)
}
...
void SystemConfig::InternalSwap(SystemConfig* other) {
  ...
  system_uuid_.Swap(&other->system_uuid_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  swap(discard_data_timestamp_, other->discard_data_timestamp_);
  swap(do_not_sync_until_, other->do_not_sync_until_);
  swap(authentication_interval_, other->authentication_interval_);
  swap(batch_upload_interval_, other->batch_upload_interval_);
  swap(last_authentication_time_, other->last_authentication_time_);
  swap(last_batch_upload_time_, other->last_batch_upload_time_);
  swap(billing_interval_, other->billing_interval_);
  swap(last_billing_time_, other->last_billing_time_);
  swap(network_constraint_, other->network_constraint_);
...
template<> PROTOBUF_NOINLINE ::clarifai::sdk::utils::SystemConfig* Arena::CreateMaybeMessage< ::clarifai::sdk::utils::SystemConfig >(Arena* arena) {
  return Arena::CreateInternal< ::clarifai::sdk::utils::SystemConfig >(arena);
}
