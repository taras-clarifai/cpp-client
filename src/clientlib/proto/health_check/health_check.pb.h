...
class HealthStartupResponse :
 ...
 public:
  ...
  private:
  ::HealthStartupResponse_ServingStatus _internal_serving_status() const;
  void _internal_set_serving_status(::HealthStartupResponse_ServingStatus value);
  public:
...
// .RequestMeta meta = 1;
inline bool HealthStartupRequest::_internal_has_meta() const {
  return this != internal_default_instance() && meta_ != nullptr;
}
inline bool HealthStartupRequest::has_meta() const {
  return _internal_has_meta();
}
inline const ::RequestMeta& HealthStartupRequest::_internal_meta() const {
  const ::RequestMeta* p = meta_;
  return p != nullptr ? *p : *reinterpret_cast<const ::RequestMeta*>(
      &::_RequestMeta_default_instance_);
}
...
inline ::RequestMeta* HealthStartupRequest::_internal_mutable_meta() {
...
inline const std::string& HealthStartupRequest::_internal_service() const {
  return service_.GetNoArena();
}
inline void HealthStartupRequest::_internal_set_service(const std::string& value) {
...
inline std::string* HealthStartupRequest::_internal_mutable_service() {
...
// .ResponseStatus status = 1;
inline bool HealthStartupResponse::_internal_has_status() const {
  return this != internal_default_instance() && status_ != nullptr;
}
inline bool HealthStartupResponse::has_status() const {
  return _internal_has_status();
}
inline const ::ResponseStatus& HealthStartupResponse::_internal_status() const {
  const ::ResponseStatus* p = status_;
  return p != nullptr ? *p : *reinterpret_cast<const ::ResponseStatus*>(
      &::_ResponseStatus_default_instance_);
}
...
inline ::ResponseStatus* HealthStartupResponse::_internal_mutable_status() {
...
inline ::HealthStartupResponse_ServingStatus HealthStartupResponse::_internal_serving_status() const {
...
inline void HealthStartupResponse::_internal_set_serving_status(::HealthStartupResponse_ServingStatus value) {
